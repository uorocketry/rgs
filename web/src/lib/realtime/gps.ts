 ...
 * In meters
 */
export const rocketAltitudeAccuracy = latestCollectionWritable<number>(
  "GpsPos2",
  0,
  (row) => {
 ...
 */
export const rocketVelocity = latestCollectionWritable<Vector3>(
  "GpsVel",
  new Vector3(),
  (row) => {
...
export const rocketCourse = latestCollectionWritable<number>(
  "GpsVel",
  0,
  (row) => {
    return row.course;
...
export const rocketCourseAccuracy = latestCollectionWritable<number>(
  "GpsVel",
  0,
  (row) => {
