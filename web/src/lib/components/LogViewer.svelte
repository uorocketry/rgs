<script lang="ts">
	...
	let avgKbps = 0;
	if (browser) {
		// TODO: Replace this by Pocketbase
...
<div class="p-2 h-full overflow-clip">
	<div class="flex gap-4 pb-2">
		...
		<div class="flex flex-1 place-items-start card bg-base-200 text-base-content">
			<!-- Filter reverse -->
			<div
				class="tooltip tooltip-right"
				data-tip={!reverseLogs ? 'Showing oldest first' : 'Showing newest first'}
			>
	...
	<VirtualList items={reverseLogs ? logs.slice().reverse() : logs} let:item bind:start bind:end>
		<div class="my-2">
