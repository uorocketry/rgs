...
<ul class="menu bg-base-200 w-16 min-h-full p-2 flex flex-col items-center gap-2">
	<!-- Top Section -->
...
<style>
	/* Adjustments for icon-only menu */
	.menu li > a {
	...
	.menu li > a:not(.active):hover {
		background-color: hsl(var(--b3)); /* Use base-300 for hover */
	}
</style>
