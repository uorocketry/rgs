...
export type RocketVelResponse<Tvelocity = unknown, Tvelocity_acc = unknown, Texpand = unknown> = Required<RocketVelRecord<Tvelocity, Tvelocity_acc>> & BaseSystemFields<Texpand>
