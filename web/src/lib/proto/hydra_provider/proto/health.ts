...
// @generated from protobuf file "hydra_provider/proto/health.proto" (package "grpc.health.v1", syntax proto3)
// tslint:disable
...
class HealthCheckRequest$Type extends MessageType<HealthCheckRequest> {
	...
	create(value?: PartialMessage<HealthCheckRequest>): HealthCheckRequest {
		...
		message.service = '';
		if (value !== undefined) reflectionMergePartial<HealthCheckRequest>(this, message, value);
		return message;
	}
	internalBinaryRead(
	...
	internalBinaryWrite(
		...
		/* string service = 1; */
		if (message.service !== '') writer.tag(1, WireType.LengthDelimited).string(message.service);
...
class HealthCheckResponse$Type extends MessageType<HealthCheckResponse> {
	...
	create(value?: PartialMessage<HealthCheckResponse>): HealthCheckResponse {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.status = 0;
		if (value !== undefined) reflectionMergePartial<HealthCheckResponse>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
