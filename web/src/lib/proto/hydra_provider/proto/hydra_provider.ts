...
class ConnectionTypeMessage$Type extends MessageType<ConnectionTypeMessage> {
    constructor() {
        super("hydra_provider.ConnectionTypeMessage", [
            { no: 1, name: "connectionType", kind: "enum", T: () => ["hydra_provider.ConnectionType", ConnectionType] }
        ]);
    }
    create(value?: PartialMessage<ConnectionTypeMessage>): ConnectionTypeMessage {
        ...
        if (value !== undefined)
            reflectionMergePartial<ConnectionTypeMessage>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ConnectionTypeMessage): ConnectionTypeMessage {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ConnectionTypeMessage, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* hydra_provider.ConnectionType connectionType = 1; */
        if (message.connectionType !== 0)
            writer.tag(1, WireType.Varint).int32(message.connectionType);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GetSerialPortsReply$Type extends MessageType<GetSerialPortsReply> {
    ...
    create(value?: PartialMessage<GetSerialPortsReply>): GetSerialPortsReply {
        ...
        message.ports = [];
        if (value !== undefined)
            reflectionMergePartial<GetSerialPortsReply>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetSerialPortsReply): GetSerialPortsReply {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetSerialPortsReply, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class SetSerialConnectionRequest$Type extends MessageType<SetSerialConnectionRequest> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SetSerialConnectionRequest): SetSerialConnectionRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SetSerialConnectionRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string portName = 1; */
        if (message.portName !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.portName);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class CheckConnectionReply$Type extends MessageType<CheckConnectionReply> {
    constructor() {
        super("hydra_provider.CheckConnectionReply", [
            ...
            { no: 2, name: "connectionType", kind: "enum", T: () => ["hydra_provider.ConnectionType", ConnectionType] },
    ...
    create(value?: PartialMessage<CheckConnectionReply>): CheckConnectionReply {
        ...
        message.errors = [];
        if (value !== undefined)
            reflectionMergePartial<CheckConnectionReply>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckConnectionReply): CheckConnectionReply {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CheckConnectionReply, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool connected = 1; */
        if (message.connected !== false)
            writer.tag(1, WireType.Varint).bool(message.connected);
        /* hydra_provider.ConnectionType connectionType = 2; */
        if (message.connectionType !== 0)
            writer.tag(2, WireType.Varint).int32(message.connectionType);
