use mavlink::{uorocketry::MavMessage, MAVLinkV2MessageRaw};
use messages::{
    sensor::{
...
fn random_radio_status_message_buf() -> mavlink::uorocketry::RADIO_STATUS_DATA {
...
fn random_state_message_buf() -> [u8; 255] {
...
fn random_sensor_message_buf() -> [u8; 255] {
...
fn main() -> std::io::Result<()> {
    let listener = TcpListener::bind("127.0.0.1:5656")?;
    println!("Server listening on 127.0.0.1:5656");
