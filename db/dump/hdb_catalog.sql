...
--
-- Name: hdb_catalog; Type: SCHEMA; Schema: -; Owner: uorocketry
--

CREATE SCHEMA hdb_catalog;


ALTER SCHEMA hdb_catalog OWNER TO uorocketry;

--
-- Name: gen_hasura_uuid(); Type: FUNCTION; Schema: hdb_catalog; Owner: uorocketry
--
...
ALTER FUNCTION hdb_catalog.gen_hasura_uuid() OWNER TO uorocketry;
...
--
-- Name: hdb_action_log; Type: TABLE; Schema: hdb_catalog; Owner: uorocketry
--
...
ALTER TABLE hdb_catalog.hdb_action_log OWNER TO uorocketry;

--
-- Name: hdb_cron_event_invocation_logs; Type: TABLE; Schema: hdb_catalog; Owner: uorocketry
--
...
ALTER TABLE hdb_catalog.hdb_cron_event_invocation_logs OWNER TO uorocketry;

--
-- Name: hdb_cron_events; Type: TABLE; Schema: hdb_catalog; Owner: uorocketry
--
...
ALTER TABLE hdb_catalog.hdb_cron_events OWNER TO uorocketry;

--
-- Name: hdb_metadata; Type: TABLE; Schema: hdb_catalog; Owner: uorocketry
--
...
ALTER TABLE hdb_catalog.hdb_metadata OWNER TO uorocketry;

--
-- Name: hdb_scheduled_event_invocation_logs; Type: TABLE; Schema: hdb_catalog; Owner: uorocketry
--
...
ALTER TABLE hdb_catalog.hdb_scheduled_event_invocation_logs OWNER TO uorocketry;

--
-- Name: hdb_scheduled_events; Type: TABLE; Schema: hdb_catalog; Owner: uorocketry
--
...
ALTER TABLE hdb_catalog.hdb_scheduled_events OWNER TO uorocketry;

--
-- Name: hdb_schema_notifications; Type: TABLE; Schema: hdb_catalog; Owner: uorocketry
--
...
ALTER TABLE hdb_catalog.hdb_schema_notifications OWNER TO uorocketry;

--
-- Name: hdb_version; Type: TABLE; Schema: hdb_catalog; Owner: uorocketry
--
...
ALTER TABLE hdb_catalog.hdb_version OWNER TO uorocketry;

--
-- Data for Name: hdb_action_log; Type: TABLE DATA; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Data for Name: hdb_cron_event_invocation_logs; Type: TABLE DATA; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Data for Name: hdb_cron_events; Type: TABLE DATA; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Data for Name: hdb_metadata; Type: TABLE DATA; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Data for Name: hdb_scheduled_event_invocation_logs; Type: TABLE DATA; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Data for Name: hdb_scheduled_events; Type: TABLE DATA; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Data for Name: hdb_schema_notifications; Type: TABLE DATA; Schema: hdb_catalog; Owner: uorocketry
--

COPY hdb_catalog.hdb_schema_notifications (id, notification, resource_version, instance_id, updated_at) FROM stdin;
1	{"metadata":false,"remote_schemas":[],"sources":[],"data_connectors":[]}	6	6892838c-06cc-4a2c-a119-a42a9cf8009c	2024-01-24 11:04:15.287876+00
\.


--
-- Data for Name: hdb_version; Type: TABLE DATA; Schema: hdb_catalog; Owner: uorocketry
--
...
af6cf757-90cb-47fa-825d-f06e85bfe126	48	2024-01-24 11:02:52.767484+00	{}	{}	\N	\N
\.


--
-- Name: hdb_action_log hdb_action_log_pkey; Type: CONSTRAINT; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Name: hdb_cron_event_invocation_logs hdb_cron_event_invocation_logs_pkey; Type: CONSTRAINT; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Name: hdb_cron_events hdb_cron_events_pkey; Type: CONSTRAINT; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Name: hdb_metadata hdb_metadata_pkey; Type: CONSTRAINT; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Name: hdb_metadata hdb_metadata_resource_version_key; Type: CONSTRAINT; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Name: hdb_scheduled_event_invocation_logs hdb_scheduled_event_invocation_logs_pkey; Type: CONSTRAINT; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Name: hdb_scheduled_events hdb_scheduled_events_pkey; Type: CONSTRAINT; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Name: hdb_schema_notifications hdb_schema_notifications_pkey; Type: CONSTRAINT; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Name: hdb_version hdb_version_pkey; Type: CONSTRAINT; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Name: hdb_cron_event_invocation_event_id; Type: INDEX; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Name: hdb_cron_event_status; Type: INDEX; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Name: hdb_cron_events_unique_scheduled; Type: INDEX; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Name: hdb_scheduled_event_status; Type: INDEX; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Name: hdb_version_one_row; Type: INDEX; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Name: hdb_cron_event_invocation_logs hdb_cron_event_invocation_logs_event_id_fkey; Type: FK CONSTRAINT; Schema: hdb_catalog; Owner: uorocketry
--
...
--
-- Name: hdb_scheduled_event_invocation_logs hdb_scheduled_event_invocation_logs_event_id_fkey; Type: FK CONSTRAINT; Schema: hdb_catalog; Owner: uorocketry
--
