...
if (process.env.DB_ADMIN === void 0 || process.env.DB_ADMIN === "") {
  console.error("DB_ADMIN is not set");
  throw new Error("DB_ADMIN is not set");
}
if (process.env.DB_ADMIN_PASSWORD === void 0 || process.env.DB_ADMIN_PASSWORD === "") {
  console.error("DB_ADMIN_PASSWORD is not set");
  throw new Error("DB_ADMIN_PASSWORD is not set");
}
if (process.env.DB_REST_PORT === void 0 || process.env.DB_REST_PORT === "") {
  ...
  if ("RocketMessage" in obj) {
    ...
    if ("state" in rocketData) {
      ...
      if ("UtcTime" in sensorData) {
        ...
        const ekfNav1 = sensorData.EkfNav1;
        ...
        const ekfNav2 = sensorData.EkfNav2;
        ...
        const gpsVel = sensorData.GpsVel;
    ...
    const linkStatus = obj.LinkStatus;
